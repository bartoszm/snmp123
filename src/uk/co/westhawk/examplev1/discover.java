 ...
 * @version $Revision: 1.3 $ $Date: 2006/01/30 11:36:57 $
 */
public class discover implements Observer
{
    private static final String     version_id =
        "@(#)$Id: discover.java,v 1.3 2006/01/30 11:36:57 birgit Exp $ Copyright Westhawk Ltd";
...
public void update(Observable obs, Object ov)
{
    ...
    else
    {
        ...
        System.out.print("SNMPv1 Agent: " + agent);
        try
        {
