// NAME
//      $RCSfile: testInterfaceBean.java,v $
// DESCRIPTION
 ...
 */
public class testInterfaceBean extends JPanel 
        implements ActionListener, PropertyChangeListener,
        WindowListener, ListSelectionListener
{
    private static final String     version_id =
        "@(#)$Id: testInterfaceBean.java,v 1.4 2006/01/17 17:43:55 birgit Exp $ Copyright Westhawk Ltd";
...
//Component initialization
    ...
    private void jbInit() throws Exception
    {
        ...
        this.add(label3, 
            ...
            new Insets(0, 0, 0, 0), 0, 0));
        this.add(new JScrollPane(interfaceList), 
...
class InterfaceListModel extends AbstractListModel
