// NAME
//      $RCSfile: testNTServiceNamesBean.java,v $
// DESCRIPTION
 ...
 */
public class testNTServiceNamesBean extends JPanel 
        implements ActionListener, PropertyChangeListener,
        WindowListener
{
    private static final String     version_id =
        "@(#)$Id: testNTServiceNamesBean.java,v 1.4 2006/01/17 17:43:55 birgit Exp $ Copyright Westhawk Ltd";
...
//Main method
    ...
    private void showOneNTService()
    {
        ...
        if (itemStr != null && itemStr.length() > 0)
        {
            ...
            OneNTService oneNTService = new
            OneNTService(testNcdPerfDataBean.getFrame(this), 
